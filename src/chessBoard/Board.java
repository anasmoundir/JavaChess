     ...
     public class Board {
          ...
          public static void chargingThesquares() {
               ...
               for (int x = 0; x <= 7; x++) {
                    for (int y = 0; y <= 7; y++) {
                         String squareIcon = (x + y) % 2 == 0 ? emptyWhiteSquareIcon : emptyBlackSquareIcon;
                         squares[x][y] = new Square(squareIcon, true, x, y);
                    }
               }
          }
          ...
          public void initializePieces() throws IllegalAccessException {
               ...
               for (int col = 0; col < 8; col++) {
                    ...
                    squares[1][col].getPiece().setX(1);
                    squares[1][col].getPiece().setY(col);
               }
               ...
               for (int col = 0; col < 8; col++) {
                    ...
                    squares[6][col].getPiece().setX(6);
                    squares[6][col].getPiece().setY(col);
               }
             }
